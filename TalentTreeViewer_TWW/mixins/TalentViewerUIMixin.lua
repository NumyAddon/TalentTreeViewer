...
function TalentViewerUIMixin:GetAndCacheNodeInfo(nodeID)
    local function GetNodeInfoCallback(nodeID)
        ...
        if not TalentViewer.db.ignoreRestrictions and isRecordingLevelingBuild and nodeInfo.requiredPlayerLevel and nodeInfo.type ~= Enum.TraitNodeType.SubTreeSelection then
